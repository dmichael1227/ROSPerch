...
made_contact = False #I haven't heard anything yet
def handshake_listener(data):
    global made_contact
    #print("I heard something!")
    #print("made_contact is %s" % made_contact)
    if made_contact == False: #only run if I haven't heard anything yet
        made_contact = True #Now I heard something
        ready_pub()
        print("I published ready")
...
def listener():
    ...
    rospy.Subscriber('command_to_driver',Bool,handshake_listener)
