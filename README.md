# ROSPerch
Greetings human!
Please refer to the README.pdf document found [here](https://github.com/mxdrew/ROSPerch/blob/master/README.pdf) for any specific questions that may not be answered in this README.md document. If you need help, feel free to [create an issue](https://github.com/mxdrew/ROSPerch/issues) and we'll be happy to help!
...
## Table of Contents
<ol>
	<li><a href="https://github.com/mxdrew/ROSPerch/blob/master/README.md#setting-up-github-getting-the-code-and-testing-it">Setting up GitHub, Getting the Code, and Testing It</a></li>
	<li><a href="https://github.com/mxdrew/ROSPerch#auto_squarepy-and-launcher_for_auto_squarepy">auto_square.py and launcher_for_auto_square.py</a></li>
	<li><a href="https://github.com/mxdrew/ROSPerch/blob/master/README.md#auto_driver-and-mission_commandspy">auto_driver and mission_commands.py</a></li>
	<li><a href="https://github.com/mxdrew/ROSPerch/blob/master/README.md#9dof_pubpy">9dof_pub.py</a></li>
	<li><a href="https://github.com/mxdrew/ROSPerch/blob/master/README.md#ssh-into-pi-over-direct-ethernet-connection">SSH into Pi Over Direct Ethernet Connection</a></li>
	<li><a href="https://github.com/mxdrew/ROSPerch/blob/master/README.pdf">README.pdf w/ Additional Information</a></li>
	<li><a href="https://github.com/mxdrew/ROSPerch/blob/master/README.md#additional-references">Additional References</a></li>
</ol>
  ...
  <ol>
	...
	<li>Clone the GitHub Repository and link it to your catkin workspace.
		<ol>
			...
			<li><code>git clone git@github.com:mxdrew/ROSPerch.git</code>
			<ol>
				<li>Alternatively, if you do not set up the SSH Keys:</li>
				<li><code>git clone https://github.com/mxdrew/ROSPerch.git</code></li>
			</ol>
			</li>
	...
	<ol>
		...
		<ol>
			...
			<li><em>Additional information on these scripts is available in the <strong><a href="https://github.com/mxdrew/ROSPerch#auto_squarepy-and-launcher_for_auto_squarepy">ROSPerch - auto_square.py and launcher_for_auto_square.py</a></strong> section below.</em></li>
		</ol>
	</ol>
	</li>
	...
	<ol>
		...
		<ol>
			...
			<li><em>Additional information on these scripts is available in the <strong><a href="https://github.com/mxdrew/ROSPerch/blob/master/README.md#auto_driver-and-mission_commandspy">ROSPerch - auto_square.py and launcher_for_auto_square.py</a></strong> section below.</em></li>
		</ol>
	</ol>
	</li>	
</ol>
